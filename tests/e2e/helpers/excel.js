...
export async function ceplRowTotal(sheetName, label) {
...
export async function cafeOutletWeeklyTotal(outletHeader, rowLabel) {
...
// cols B..M).
export async function siennaChannelYearTotals(aprilHeaderYY) {
...
export async function consignmentYearTotal(aprilHeaderYY) {

...
export const RESOURCES = [
  'Employee', 'Licence', 'Recruitment', 'LeaveRequest', 'PayrollRecord', 'Inventory',
...
const FULL_CRUD: Resource[] = ['Employee', 'Licence', 'Recruitment', 'LeaveRequest', 'PayrollRecord', 'Inventory', 'Import', 'SheetSource', 'Invite', 'User', 'Role'];

...
export const RESOURCES = [
  'Employee', 'Licence', 'Recruitment', 'LeaveRequest', 'PayrollRecord',
...
const FULL_CRUD: Resource[] = ['Employee', 'Licence', 'Recruitment', 'LeaveRequest', 'PayrollRecord', 'Import', 'SheetSource', 'Invite', 'User', 'Role'];
